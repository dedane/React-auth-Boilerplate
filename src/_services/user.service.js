...
function getAll() {
    ...
    return fetch(`https://yents-backend.herokuapp.com/users`, requestOptions).then(handleResponse);
}
...
function getById(id) {
    ...
    return fetch(`https://yents-backend.herokuapp.com/users/${id}`, requestOptions).then(handleResponse);
}
